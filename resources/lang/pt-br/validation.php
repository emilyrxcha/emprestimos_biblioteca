...
return [
    'custom' => [
        'data_inicio' => [
            'date_format' => 'A data de início da função inserida não tem formato válido',
            'after'  => 'A data de início da função inserida é muito antiga',
            'before' => 'A data de início inserida é mais recente que a data de fim da função',
        ],

        'data_fim' => [
            'date_format' => 'A data de fim da função inserida não tem formato válido',
            'after'  => 'A data de fim da função é mais antiga que a data de início',
            'before' => 'A data inserida está no futuro',
        ],

        'data_nascimento' => [
            'date_format' => 'A data de nascimento inserida não tem formato válido',
            'after'  => 'A data de nascimento inserida é muito antiga',
            'before' => 'A data inserida está no futuro',
        ],

        'tempo_medio_unitario' => [
            'date_format' => 'O tempo médio unitário deve ser um horário dentro do intervalo de 24 horas',
        ],
    ],
    ...
    'attributes'           => [
        ...
        'day'                      => 'dia',
        'data_inicio'              => 'data de início da função',
        'data_fim'                 => 'data de fim da função',
